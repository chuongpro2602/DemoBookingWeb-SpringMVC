...
public class BookingRoomService {
	...
	public List<BookingRoomEntity> findAllBooking(){
		return (List<BookingRoomEntity>) bookingRoomRepository.findAll();
	}
...
//	}
	...
	public Page<BookingRoomEntity> getProductsPaging(int page) {
	  return (Page<BookingRoomEntity>) bookingRoomRepository.findAll(PageRequest.of(page - 1, pagingNumber));
	}
