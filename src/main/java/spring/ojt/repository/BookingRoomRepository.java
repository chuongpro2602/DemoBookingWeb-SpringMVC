...
//	public List<BookingRoomEntity> findByCriteria(@Param("keyword") String keyword);
	@Query("Select br from BookingRoomEntity br")
	public List<BookingRoomEntity> findAll();
	
//	@Query(value = "SELECT SUM(TotalPrice) FROM bookingroom where IdBookingStatus = '1'", nativeQuery = true)
//	public BookingRoomEntity totalPrice();
}
