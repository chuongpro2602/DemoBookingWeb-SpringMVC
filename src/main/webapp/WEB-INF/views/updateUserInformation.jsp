				...
				<div class="left_col scroll-view">
					...
					<div class="profile clearfix">
						<div class="profile_pic">
							<img src="https://scontent.fdad3-3.fna.fbcdn.net/v/t1.6435-9/195742432_525006935298525_6400879309236686546_n.jpg?_nc_cat=100&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=GiWsH-h5vpgAX9LREJf&tn=93qchO_iMVXbR0he&_nc_ht=scontent.fdad3-3.fna&oh=3a1625f26fe92ea4a0204f03b2411fce&oe=613F951F" alt="..."
							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> Home <span
									...
									<ul class="nav child_menu">
										...
										<li><a href="${pageContext.request.contextPath}/home">Return
												Home</a></li>
									</ul></li>
								...
								<li><a><i class="fa fa-table"></i> Quản lý <span
									...
									<ul class="nav child_menu">
										...
										<li><a
											href="${pageContext.request.contextPath}/user/accountUser">
												Update thông tin tài khoản </a></li>
									</ul></li>
					...
					<nav class="nav navbar-nav">
						<ul class=" navbar-right">
							<li class="nav-item dropdown open" style="padding-left: 15px;">
								...
								aria-expanded="false"> <img src="https://scontent.fdad3-3.fna.fbcdn.net/v/t1.6435-9/195742432_525006935298525_6400879309236686546_n.jpg?_nc_cat=100&ccb=1-5&_nc_sid=8bfeb9&_nc_ohc=GiWsH-h5vpgAX9LREJf&tn=93qchO_iMVXbR0he&_nc_ht=scontent.fdad3-3.fna&oh=3a1625f26fe92ea4a0204f03b2411fce&oe=613F951F" alt="">User
							</a>
				...
				<div class="">
					<div class="page-title">
						<div style="padding-bottom: 20px" class="title_left">
							<h3 class="text-capitalize">Update Account</h3>
					...
					<form:form method="post" action="doUpdateAccountUser"
						modelAttribute="user">
					...
					<a style="font-size: 20px" href="history">Return Lịch sử
						booking</a>
				</div>
			</div>
		</div>
