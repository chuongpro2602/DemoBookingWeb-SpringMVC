							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-table"></i> Quản lý <span
									...
									<ul class="nav child_menu">
										...
										<li><a
											href="${pageContext.request.contextPath}/staff/bookingAdmin">
												Quản lý Booking </a></li>
							...
							<div class="x_content">
                              ...
                              <input type="checkbox" id="check-all" class="flat">
										...
										<tbody>
											...
											<c:choose>
												<c:when
													test="${bookingEntity !=null && bookingEntity.size() gt 0}">
													<c:forEach items="${bookingEntity }" var="item">
