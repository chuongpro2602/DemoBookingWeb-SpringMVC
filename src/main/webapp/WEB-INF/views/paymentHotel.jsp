	...
	<div class="container-fluid">
			...
			<div class="row">
				<div class="col-12 col-sm-12 col-lg-6 border rounded">
					...
					<div class="form-group row">
						...
						<label for="fullname"
							class="col-sm-4 col-form-label font-weight-bold">Tên
							Phòng </label>
						<div class="col-sm-8">
					...
					<form:errors path="bookingRoomEntity.customersEntity.dob"
						cssClass="error" />
					<div class="form-group row">
						<label for="Dob" class="col-sm-4 col-form-label font-weight-bold">Dob
							(*)</label>
						<div class="col-sm-8">
					...
					<div class="form-group row">
						<label for="address"
							class="col-sm-4 col-form-label font-weight-bold">Địa chỉ
							(*)</label>
						<div class="col-sm-8">
              ...
              <div class="col-12">
                <p>
                  ...
                  ><span>2 Người lớn - 0 trẻ nhỏ</span>
					...
					<c:forEach items="${serviceEntity }" var="item">
						<p>
							<b>Tên</b> : ${item.nameService }. <b>Giá</b> :${item.price }
							VND.<br> <b>Chi tiết</b>: ${item.mota } <br>
							<b>Khuyến mãi</b>: ${item.promotionEntity.percentage } %
						</p>
		...
		<script>
			function getTotalPrice(event) {
				...
				const val1 = document.querySelector('option[value="'
						+ khuyenmai + '"]').text;
				const val2 = val1.split(' ');
				//console.log('vi tri 1 :' +  val2[1],'vi tri 2 :' + val2[2],'vi tri 3 :' +  val2[3]);
