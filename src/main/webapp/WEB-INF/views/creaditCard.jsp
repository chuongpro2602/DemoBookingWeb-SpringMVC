					...
					<div class="row">
						...
						<div class="col-50">
							...
							<h5>
								...
								<c:out value="${sessionScope.totalPrice } VND. ">
								</c:out>
							</h5>
							<h5>
								Từ ngày
								<c:out value="${sessionScope.startDate } " /> đến ngày
								<c:out value="${sessionScope.endDate }. " />
							</h5>
                            <h5>Khách sạn : <c:out value="${sessionScope.nameHotel }. " /></h5>
                             <h5>Địa chỉ : <c:out value="${sessionScope.address }. " /></h5>
                             <h5> <c:out value="${sessionScope.quantity } " /> phòng <c:out value="${sessionScope.nameroom } " />     </h5>
                             <h5> <c:out value="${sessionScope.adult } " /> người lớn <c:out value="${sessionScope.child } " />  trẻ em   </h5>
						</div>
					</div>
