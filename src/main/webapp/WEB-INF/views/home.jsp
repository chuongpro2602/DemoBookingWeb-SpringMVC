...
<body>
	...
	<div class="container-fluid">
				...
				<nav class="navbar">
					...
					<ul class="navbar-nav">
						<li><a href="${pageContext.request.contextPath}/home">
								Khách Sạn </a></li>
						<li><a href="${pageContext.request.contextPath}/tour">
								Tour </a></li>
		...
		<form class="search-fixed" action="searchHotel" method="get">
			...
			<div class="button-toggle">
				<p class="text-white">Find Your Hotel</p>
			</div>
		</form>
		...
		<%-- 	<div class="col-12 col-md-3 col-lg-3 col-xl-3 p-0">
			...
			<div class="col-12 col-md-9 col-lg-9 col-xl-9 p-0" style="margin-left: 350px">
				<!-- content local -->
				<div class="content">
					...
					<div class="content-type my-5">
						...
						<div class="type-travel">
							<c:choose>
								...
								<c:when test="${listHotel != null && listHotel.size() gt 0}">
									<c:forEach items="${listHotel }" var="item">
										<div class="card-travel m-4">
											...
											<a href="detailHotel?id=${item.id }"><img
												src="${pageContext.request.contextPath}/image/${item.urlImage}" /></a>
											<div class="info-travel p-4">
												<p class="text-title text-white m-0 d-block"
													style="font-size: 2em; text-decoration: none">${item.ten }
												</p>
									...
									<%-- 	<tr>
								<td colspan="5"><c:import url="common/paging.jsp" /></td>
							</tr> --%>
								</c:when>
								<c:otherwise>
			...
			<div class="row">
				<div class="col-12 col-md-12">
					<h2 style="margin-left: 30px"
						class="text-center text-capitalize mt-5 mb-3">Information</h2>
					<div class="d-flex flex-wrap justify-content-center">
						...
						<div class="row m-2">
							<div class="col-md-12 col-6">
								<div style="margin-left: 15px;padding-left: 70px;padding-right: 70px" 
									class="col-md-12 col-8 card hovercard">
									<div class="cardheader"></div>
									<div class="avatar">
										<img alt=""
											src="https://scontent-sin6-3.xx.fbcdn.net/v/t1.6435-9/64803759_147473089756385_8046068707283173376_n.jpg?_nc_cat=110&ccb=1-5&_nc_sid=174925&_nc_ohc=HKbfkYJNyOsAX-gVk1a&_nc_ht=scontent-sin6-3.xx&oh=ad4f94653e54d0cd7196b04f01ddd5b8&oe=614652BF" />
									</div>
									<div class="info">
										<div class="title">
											<a target="_blank" href="#"
												style="text-decoration: none; font-size: 20px">Chu
												Nguyên Chương</a>
										</div>
