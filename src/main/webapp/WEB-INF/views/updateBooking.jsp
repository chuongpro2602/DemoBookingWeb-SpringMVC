				...
				<div class="">
					...
					<%-- 	 <div class="form-group row">
							<label style="font-size: 16px" class="col-sm-1 col-form-label">Tên
								Khách Sạn</label>
							<div class="col-4 mb-4">
								<form:hidden path="roomEntity.hotelEntity.danhGia" type="text"
									cssClass="form-control" readonly="true" />				
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:hidden path="roomEntity.hotelEntity.diaChi" type="text"
									cssClass="form-control" readonly="true" />
						...
						<div class="form-group row">
							...
							<div class="col-4 mb-4">
								...
								<form:hidden path="roomEntity.hotelEntity.moTa" type="text"
									cssClass="form-control" readonly="true" />
