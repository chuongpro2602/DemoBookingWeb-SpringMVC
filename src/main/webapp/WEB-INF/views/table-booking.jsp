				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3 class="text-capitalize">Quản Lý Booking</h3>
						</div>
						...
						<div class="x_panel">
							<div class="x_title">
								<ul class="nav navbar-right panel_toolbox">
									<a	href="${pageContext.request.contextPath}/staff/bookingAdmin1"
										class="btn btn-primary btn-sm" data-whatever="@mdo"><i
										class="fa fa-plus"></i> Huỷ đơn </a>
							...
							<div class="x_content">
                              ...
                              <input type="checkbox" id="check-all" class="flat">
												...
												<th class="column-title">ID Booking</th>
												...
												<th class="column-title">Đã huỷ</th>
												...
												<c:when
													...
													<c:forEach items="${bookingDetailEntity }" var="item">
														<tr class="even pointer">
															<td>${item.id }</td>
															<td>${item.bookingRoomEntity.id }</td>
